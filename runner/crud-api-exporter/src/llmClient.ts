...
Для каждой сущности, кроме отмеченных как 'is dependent', создай полный набор DTO:
...
Для каждой сущности, кроме отмеченных как 'is dependent', сгенерируй по 5 эндпоинтов: получение списка, получение элемента по ключу, добавление, изменение и удаление.
(Сущности, отмеченные как 'is dependent', включены в состав родительской и управляются каскадно, одновоременно с родительской). 
